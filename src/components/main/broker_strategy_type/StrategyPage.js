...
export default function BrokerPageFC() {
    ...
    return (
        <div className="broker upload">
            ...
            <StrategyTypyFC handleClick={handleClick}/>
            {/* НЕ УДАЛЯТЬ !!! расскоментировать/ Вкладка "Через ,рокера" */}
            <SelectFC list={list}/>
            <div className="content">
                <h3>Финансовый эксперт</h3>
                <p>
                    "Финансовый Эксперт" — ведущий финансовый дом, специализирующийся на консультировании клиентов по
                    инвестициям, управлению портфелем и финансовому планированию. Компания предлагает широкий спектр
                    услуг, включая торговлю акциями, облигациями, фондами и деривативами. Их команда экспертов постоянно
                    отслеживает рынок и предоставляет клиентам высококачественные финансовые решения.
                </p>
            </div>
